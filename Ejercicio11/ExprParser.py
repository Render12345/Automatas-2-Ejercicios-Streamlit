...
def serializedATN():
    return [
        4,1,19,10,2,0,7,0,2,1,7,1,1,0,1,0,1,0,1,1,1,1,1,1,0,0,2,0,2,0,1,
        1,0,6,7,7,0,4,1,0,0,0,2,7,1,0,0,0,4,5,3,2,1,0,5,6,5,0,0,1,6,1,1,
...
class ExprParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "PUBLIC", "CLASS", "STATIC", "VOID", 
                      "INT", "IDF", "NUM", "CADENA", "ASIG", "SUMA", "LI", 
                      "LD", "PI", "PD", "CI", "CD", "P", "PC", "WS" ]
